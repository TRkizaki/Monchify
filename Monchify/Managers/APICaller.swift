...
final class APICaller {
        ...
        createRequest(
            ...
            let task = URLSession.shared.dataTask(with: request) { data, _, error in
                ...
                do {
                    ...
                    print(result)
                    completion(.success(result.items.compactMap({ $0.album }))) //new
    ...
    public func getFuturedPlaylists (completion: @escaping ((Result<FeaturedPlaylistsResponse, Error>) -> Void)) {
    ...
    public func getRecommendations (genres: Set<String>, completion: @escaping
        ((Result<RecommendationsResponse, Error>) -> Void)) {
